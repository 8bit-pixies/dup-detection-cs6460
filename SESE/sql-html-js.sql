...
dupes.id as did, dupes.title as dtitle, dupes.body as dbody, dupes.tags, dupes.creationdate as dcreationdate
from posts p
inner join posttags pt on pt.postid = p.id
inner join tags t on pt.tagid = t.id
inner JOIN PostLinks links ON (p.Id = links.RelatedPostId AND LinkTypeId = 3)
