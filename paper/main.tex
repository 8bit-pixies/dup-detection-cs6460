...
In Stack Overflow, users will manually detect duplicate questions. In our setup we successfully identified over 1,000 questions which were either marked as duplicates or manually linked to another question. These questions formed the basis for our duplicate labels. 
